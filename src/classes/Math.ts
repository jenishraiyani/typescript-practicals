...
export class Calculation {
  ...
  getMathFunctionValue(clickedId: string) {
    switch (clickedId) {
      case "rand":
  ...
  getTrigonometryValue(clickedId: string) {
    switch (clickedId) {
      case "sin":
